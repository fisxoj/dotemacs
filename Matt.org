...
#+begin_src emacs-lisp
    (use-package magit
      ...
      (use-package github-browse-file
        :ensure t)
      (define-key magit-mode-map (kbd "C-c g f" #'github-browse-file))
      (define-key magit-mode-map (kbd "C-c g b" #'github-browse-file-blame)))
...
Stuff to make projectile run lisp unit tests that are wired up with asdf!
#+BEGIN_SRC emacs-lisp
(defun projectile-cl ()
...
(use-package go-mode
  :ensure t
  :defer t
  :init (bind-key "M-."  'godef-jump go-mode-map)
  :config
